 ...
 */
/**
 * 自定义角色健鉴权过滤器 + 扩展鉴权失败ajax提示 Author:xiaoyu  类的作用：
 */
public class CustomPermissionsAuthorizationFilter extends AuthorizationFilter {
    ...
    public boolean isAccessAllowed(ServletRequest request,
    	...
    	System.out.println("开始模块CustomPermissionsAuthorizationFilter鉴权==================");
    	HttpServletRequest   httpRequest=(HttpServletRequest)request;
        ...
        System.out.println("结束模块CustomPermissionsAuthorizationFilter鉴权==================："+isPermitted);
