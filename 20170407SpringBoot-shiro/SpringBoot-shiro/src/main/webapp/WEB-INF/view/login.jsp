	...
	<div class="middle-box text-center loginscreen  ">
        <div >
            ...
            <div class = "animated bounceInLeft" onclick="boke();">
                © 2017 All Rights Reserved. YU|FISH-YU
            </div>
        </div>
    </div>
		...
		$.ajax({
			...
			success : function(result) {
				...
				if (result.status != 200) {
					swal("没毛病啊，但是没进去",result.message,"error");
				} else {
					swal({title:"嗯哼 小伙子不错！请确认跳转首页",text:"登录成功，进入系统！",type:"success"}, 
						function () {
						location.href = "index?redirectUrl="+result.redirect;
				    });
				}
			}
		});
