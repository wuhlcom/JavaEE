...
public class UserEntity extends BaseEntity {
	...
	private String account;// `account` varchar(32) NOT NULL COMMENT '登录账户',
	...
	private String usesr_number;// `user_number` varchar(20) NOT NULL COMMENT
								// '编号',
	...
	public String getUsesr_number() {
		return usesr_number;
	}

	public void setUsesr_number(String usesr_number) {
		this.usesr_number = usesr_number;
	}
	...
	public String toString() {
		return "UserEntity [account=" + account + ", password=" + password + ", username=" + username + ", idcard="
				+ idcard + ", usesr_number=" + usesr_number + ", sex=" + sex + ", birth=" + birth + ", role_id="
				+ role_id + ", user_discription=" + user_discription + ", position=" + position + ", isdel=" + isdel
