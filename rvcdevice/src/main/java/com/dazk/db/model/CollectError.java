...
public class CollectError extends BaseEntity{
    ...
    public CollectError(String device_type, String device_code, Long occur_time, Long recover_time, String error_type, String error_code, Integer status,String build_code) {
