...
public class PrisonerController {
	...
	public Result add(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			return Result.error(StatusCode.UNKNOW_ERR.getCode(),"添加囚徒异常");
		}
	}
	...
	public Result delete(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			return Result.error(StatusCode.UNKNOW_ERR.getCode(),"删除用户异常");
		}
	}
	...
	public Result update(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			return Result.error(StatusCode.UNKNOW_ERR.getCode(),"更新囚徒信息");
		}
	}
}
