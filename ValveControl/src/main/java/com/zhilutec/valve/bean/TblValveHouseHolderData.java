...
public class TblValveHouseHolderData {	
	 ...
	 * @param return_temp
	 */
	public TblValveHouseHolderData(String house_code, String dtu_code, String comm_address, Long collect_time,
	...
	public TblValveHouseHolderData(){
