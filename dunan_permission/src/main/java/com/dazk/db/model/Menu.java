...
public class Menu extends BaseEntity implements Comparable<Menu> {
	...
	public Menu(Long id, String name, String code, String uri, Integer is_menu, Long lv, Long role_id,
			Integer include_url, Long created_at, Integer isdel, Long parent_id, String front_router, String menuicon) {
		super();
		this.id = id;
		this.name = name;
		this.code = code;
	...
	public String toString() {
		return "Menu [id=" + id + ", name=" + name + ", code=" + code + ", uri=" + uri + ", is_menu=" + is_menu
				...
				+ ", isdel=" + isdel + ", parent_id=" + parent_id + ", front_router=" + front_router + ", menuicon="
				+ menuicon + "]";
	}
