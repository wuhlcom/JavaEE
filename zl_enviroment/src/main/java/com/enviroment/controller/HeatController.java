...
public class HeatController {
	...
	public final static Logger logger = LoggerFactory.getLogger(HeatController.class);
...
//			parameter.put("user_id", rsToken.getString("userid"));
			...
			return heatService.result(parameter);
		} catch (Exception e) {
			e.printStackTrace();
			return new ResultErr(ResultStatusCode.ROUTINE_ERR.getCode(), "查询热力表数据出现异常");
		}
	}
}
